            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="freelancer" className="cursor-pointer">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Offer your services and find projects</div>
                </div>
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="client" className="cursor-pointer">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Hire talent and post projects</div>
                </div>
              </Label>
            </div>
          </RadioGroup>
