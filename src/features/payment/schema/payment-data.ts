...
export const mockClientPaymentData: PaymentState = {
  transactions: [
    {
      id: "1",
      type: "withdrawn",
      ...
      currency: "USD",
      status: "completed",
      description: "Payment to freelancer for completed project",
      projectName: "E-commerce Website Redesign",
    ...
    },
    {
      ...
      currency: "USD",
      status: "pending",
      description: "Payment scheduled for project milestone",
      projectName: "Mobile App Development",
    ...
    },
    {
      ...
      currency: "USD",
      status: "completed",
      description: "Welcome bonus - Account credits",
    ...
    },
    {
      ...
      currency: "USD",
      status: "completed",
      description: "Refund received for cancelled project",
      projectName: "WordPress Plugin Development",
    ...
    },
    {
      ...
      currency: "USD",
      status: "failed",
      description: "Funds deposit via PayPal - Failed",
    ...
    },
    {
      ...
      currency: "USD",
      status: "completed",
      description: "Initial funds added via Bank Transfer",
  ...
  stats: {
    totalEarnings: 18525,
    availableBalance: 5825,
    pendingBalance: 3708,
    withdrawnAmount: 20000,
    thisMonthEarnings: 13709,
    lastMonthEarnings: 4816,
    currency: "USD",
  },
  withdrawalAccounts: [
    {
    ...
    },
    {
      id: "3",
      method: "bank",
      accountName: "Bank of America - Business",
      accountNumber: "****5678",
      isDefault: false,
      isVerified: true,
    },
