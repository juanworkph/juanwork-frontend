        ...
        <CardContent className="p-4 lg:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl lg:text-2xl font-bold">${stats.totalEarnings.value.toLocaleString()}</p>
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className="text-xs text-muted-foreground hidden sm:inline">{stats.totalEarnings.period}</span>
              </div>
            </div>
        ...
        <CardContent className="p-4 lg:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl lg:text-2xl font-bold">{stats.activeProjects.value}</p>
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className="text-xs text-muted-foreground hidden sm:inline">{stats.activeProjects.period}</span>
              </div>
            </div>
        ...
        <CardContent className="p-4 lg:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl lg:text-2xl font-bold">{stats.profileViews.value}</p>
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className="text-xs text-muted-foreground hidden sm:inline">{stats.profileViews.period}</span>
              </div>
            </div>
        ...
        <CardContent className="p-4 lg:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl lg:text-2xl font-bold">{stats.completionRate.value}%</p>
              <div className="flex items-center gap-1 mt-2">
                ...
                <span className="text-xs text-muted-foreground hidden sm:inline">{stats.completionRate.period}</span>
              </div>
            </div>
