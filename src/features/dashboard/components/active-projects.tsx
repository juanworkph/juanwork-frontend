...
export function ActiveProjects({ projects }: ActiveProjectsProps) {
  ...
  return (
    <div className="lg:col-span-2 space-y-6 p-6 rounded-xl bg-card-accent border border-border !h-auto">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold tracking-tight">Active Projects</h2>
          <p className="text-sm text-muted-foreground">
            Currently working on {projects.length} projects
          </p>
        </div>
        <Link
          ...
          >
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              <div className="flex-shrink-0">
                <Avatar className="w-12 h-12 shadow-sm ring-2 ring-background">
                ...
                <div className="flex flex-col xl:flex-row xl:justify-between xl:items-start gap-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.skills.map((skill) => (
                        <span
                          key={skill}
                          className="px-2.5 py-1 text-xs font-medium rounded-full bg-orange-500/10 text-orange-600 dark:text-orange-400 border border-orange-500/20"
                        >
                          {skill}
                        </span>
                      ))}
                  ...
                  <div className="flex flex-col sm:flex-row xl:flex-col items-start sm:items-center xl:items-end gap-3 xl:gap-2 xl:min-w-[200px]">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge
                        variant="outline"
                        className="h-6 whitespace-nowrap bg-background"
                      >
                        {project.status}
                      </Badge>
                    </div>
