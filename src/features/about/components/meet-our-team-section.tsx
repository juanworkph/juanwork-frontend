      ...
      <div className="px-4 md:px-6 max-w-7xl mx-auto">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="mx-auto max-w-3xl text-lg text-muted-foreground">
            Meet the passionate individuals who are building the future of remote work.
            Our diverse, global team brings together decades of experience and a shared vision
        ...
        <div className="mt-16 text-center space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              ...
              the future of work. Explore opportunities to join our mission.
            </p>
          </div>
