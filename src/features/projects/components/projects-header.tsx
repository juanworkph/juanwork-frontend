...
import { ProjectsState, formatCurrency } from "../schema";
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                {isClient
                  ...
                  : `$${stats.totalEarnings.toLocaleString()} total earnings`}
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <Input
              placeholder={
                isClient
                  ? "Search projects by name, freelancer, or category..."
                  : "Search projects by name, client, or category..."
              }
