      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
          ...
          <p className="text-2xl font-bold text-green-900 dark:text-green-100 mt-1">
            {totalProjects > 0 ? Math.floor(totalProjects * 0.4) : 0}
          </p>
        </div>
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-4 rounded-lg border border-purple-200 dark:border-purple-800">
          ...
          <p className="text-2xl font-bold text-purple-900 dark:text-purple-100 mt-1">
            {totalProjects > 0 ? Math.floor(totalProjects * 0.3) : 0}
          </p>
        </div>
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 p-4 rounded-lg border border-orange-200 dark:border-orange-800">
          ...
          <p className="text-2xl font-bold text-orange-900 dark:text-orange-100 mt-1">
            {totalProjects > 0 ? Math.floor(totalProjects * 15) : 0}
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Select value={sortBy} onValueChange={onSortChange}>
          ...
          <SelectContent>
            ...
            <SelectItem value="least-proposals">Least Proposals</SelectItem>
